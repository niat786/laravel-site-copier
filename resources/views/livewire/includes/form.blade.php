      <div
          ...
          <div class="space-y-2">
              ...
              @endphp
              <label for="url-{{ $random }}" class="font-bold text-green-600 ">Template
                  URL<sup class="text-rose-500">*</sup>
              </label>
              <div class="flex">
                  <input type="url" id="url-{{ $random }}" x-on:input="urlIsValid=true" wire:model="url"
                      autocomplete="url"
              ...
              <div class="flex pt-2 space-x-2">
                  @if ($showDownloadBtn == 1)
                      ...
                      <button wire:click="addNewDownloading"
                          class="flex p-3 text-sm text-white bg-green-600 border border-none rounded-lg shadow-md dark:text-gray-100 shadow-green-500/30 hover:bg-green-500">
                  ...
                  @else
                      <button type="submit" wire:click="getTheTemplate" x-on:click="downloading = 1"
                          ...
                          {{-- cog icon --}}
                          <div class="flex" x-show="downloading">
                              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                  stroke-width="1.5" stroke="currentColor" class="w-5 h-5 animate-spin">
                                  <path stroke-linecap="round" stroke-linejoin="round"
          ...
          <div class="pt-1 space-y-3 text-sm">
